...
/***/ function(module, exports, __webpack_require__) {
	...
	SmartSearch = (function() {
	  function SmartSearch(arg) {
	    var _, options, resources;
	    _ = arg._, resources = arg.resources, options = arg.options;
	    this.search = bind(this.search, this);
	    this._ = _;
	    this.Resources = resources ? resources : false;
	    this.limit = 3;
	  }
	  ...
	  SmartSearch.prototype.search = function(searchString) {
	    ...
	    results = this._.map(this.Resources, (function(_this) {
	    ...
	    results = this._.sortBy(results, 'score').reverse();
	    ret = [];
	    res = 0;
	    while (res < this.limit) {
	      ret.push(results[res].name);
	      res++;
	    }
	    return ret;
	  };
